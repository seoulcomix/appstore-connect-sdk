...
export const TerritoryAvailabilityAttributesContentStatusesEnum = {
    ...
    TraderStatusNotProvided: 'TRADER_STATUS_NOT_PROVIDED',
    TraderStatusVerificationFailed: 'TRADER_STATUS_VERIFICATION_FAILED',
    TraderStatusVerificationStatusMissing: 'TRADER_STATUS_VERIFICATION_STATUS_MISSING',
