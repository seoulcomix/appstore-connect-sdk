...
import type { CertificateCreateRequestDataRelationships } from './CertificateCreateRequestDataRelationships';
import {
    CertificateCreateRequestDataRelationshipsFromJSON,
    CertificateCreateRequestDataRelationshipsFromJSONTyped,
    CertificateCreateRequestDataRelationshipsToJSON,
} from './CertificateCreateRequestDataRelationships';
...
export interface CertificateCreateRequestData {
    ...
    /**
     * 
     * @type {CertificateCreateRequestDataRelationships}
     * @memberof CertificateCreateRequestData
     */
    relationships?: CertificateCreateRequestDataRelationships;
}
...
export function CertificateCreateRequestDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): CertificateCreateRequestData {
    ...
    return {
        ...
        'relationships': !exists(json, 'relationships') ? undefined : CertificateCreateRequestDataRelationshipsFromJSON(json['relationships']),
    };
}
...
export function CertificateCreateRequestDataToJSON(value?: CertificateCreateRequestData | null): any {
    ...
    return {
        ...
        'relationships': CertificateCreateRequestDataRelationshipsToJSON(value.relationships),
    };
}
