...
export function BetaGroupAttributesFromJSONTyped(json: any, ignoreDiscriminator: boolean): BetaGroupAttributes {
    ...
    return {
        ...
        'iosBuildsAvailableForAppleVision': !exists(json, 'iosBuildsAvailableForAppleVision') ? undefined : json['iosBuildsAvailableForAppleVision'],
    };
}
...
export function BetaGroupAttributesToJSON(value?: BetaGroupAttributes | null): any {
    ...
    return {
        ...
        'iosBuildsAvailableForAppleVision': value.iosBuildsAvailableForAppleVision,
    };
}
